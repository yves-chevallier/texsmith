...
\fill[slotcolor-nw] ($(SW)+(0,10)$) rectangle ++(10,10);
...
\fill[slotcolor-ne] ($(SW)+(10,10)$) rectangle ++(10,10);
\node[text=white,font=\bfseries\Large,align=center]
at ($(SW)+(15,15)$)
{\parbox{\boxwidth}{
...
\fill[slotcolor-sw] ($(SW)+(0,0)$) rectangle ++(10,10);
\node[text=white,font=\bfseries\Large,align=center]
at ($(SW)+(5,5)$)
{\parbox{\boxwidth}{
...
\fill[slotcolor-se] ($(SW)+(10,0)$) rectangle ++(10,10);
\node[text=white,font=\bfseries\Large,align=center]
at ($(SW)+(15,5)$)
{\parbox{\boxwidth}{
