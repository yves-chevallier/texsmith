...
In Python, you can achieve similar functionality using the \texttt{find} method of strings for example: {\ttfamily \PY{n}{haystack}\PY{o}{.}\PY{n}{find}\PY{p}{(}\PY{n}{sub}\PY{p}{:}\PY{n+nb}{int}\PY{p}{)}\PY{o}{\PYZhy{}\allowbreak{}}\PY{o}{\PYZgt{}}\PY{n+nb}{int}
