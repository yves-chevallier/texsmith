...
#align(center)[
  ...
  #linebreak()
  #text(size: 1.2em)[The `{margin}[…]` inline extension]
]
#align(center)[
  TeXSmith]
#v(1.5em)
...
Most readers appreciate a short quip#footnote[default note] that sits
...
Some diagrams read better when labelled on the left#footnote[left-hand
pointer], while running commentary fits the right-hand
margin#footnote[right-hand commentary] more naturally. Mixing the two in
...
Viscoelastic materials can be approximated as linear#footnote[*Hooke's*
...
grid.#footnote[Longer notes wrap over several lines and keep flowing down
...
- Classical mechanics#footnote[see Newton, _Principia_, 1687] predates
    the calculus of variations.
- Modern formulations rely on Lagrangians#footnote[or Hamiltonians for
    energy-based analyses] and variational principles.
- Quantum mechanics#footnote[introduces non-commuting
    observables] follows in the 20#super[th] century.
