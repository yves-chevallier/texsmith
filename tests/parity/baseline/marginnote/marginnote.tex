...
selecting a margin explicitly. It compiles down to \tscodeinline{\textbackslash{}tsaside}: a \tscodeinline{\textbackslash{}marginpar}
that \tscodeinline{marginfix} moves past the previous note on the document's own side, a
\tscodeinline{\textbackslash{}marginnote} fixed at its line on the other side or inside a box.
