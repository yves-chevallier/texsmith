...
\item{} \hyperref[snippet:<HASH>]{Snippet blocks} for embedding PDF previews
\item{} ...

\end{itemize}
Each example lives in its own folder inside the \texttt{examples/} directory of the \href{https://github.com/yves-chevallier/texsmith/tree/master/examples}{TeXSmith repository}. Feel free to dive into the source files, front matter, and templates to see exactly how each document is assembled.
