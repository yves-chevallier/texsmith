...
\end{Verbatim}
\end{tscode}
\begin{tscode}[lang=yaml, class={snippet}, engine=pygments]
\begin{Verbatim}[commandchars=\\\{\},breaklines, breakanywhere, commandchars=\\\{\}]
\PY{n+nt}{layout}\PY{p}{:}\PY{+w}{ }\PY{l+lScalar+lScalarPlain}{4x2}
\PY{n+nt}{cwd}\PY{p}{:}\PY{+w}{ }\PY{l+lScalar+lScalarPlain}{../../examples/book}
\PY{n+nt}{sources}\PY{p}{:}
\PY{+w}{  }\PY{p+pIndicator}{\PYZhy{}}\PY{+w}{ }\PY{l+lScalar+lScalarPlain}{book.md}
\PY{+w}{  }\PY{p+pIndicator}{\PYZhy{}}\PY{+w}{ }\PY{l+lScalar+lScalarPlain}{<STEM>.bib}
\PY{n+nt}{template}\PY{p}{:}\PY{+w}{ }\PY{l+lScalar+lScalarPlain}{book}
\PY{n+nt}{fragments}\PY{p}{:}
\PY{+w}{  }\PY{n+nt}{ts\PYZhy{}frame}\PY{p}{:}
\PY{n+nt}{press}\PY{p}{:}
