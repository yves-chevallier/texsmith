...
extend TeXSmith without patching the core read \tsscript{symbols}{\(\rightarrow\) }IR \tsscript{symbols}{\(\rightarrow\) }write pipeline.
...
\begin{enumerate}
\item Create a module (e.g., \tscodeinline{texsmith.plugins.acme}) exposing a Markdown
