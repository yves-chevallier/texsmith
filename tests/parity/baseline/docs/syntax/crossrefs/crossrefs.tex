...
\hyperref[snippet:<HASH>]{diagnostics}, shown by default and promotable to hard
failures with \texttt{-\allowbreak{}-\allowbreak{}strict} (or \texttt{press.features.strict: true}):
