...
#quote(block: true)[
Ship it #ts-emoji[🚀] #ts-emoji[😄] at 12:30:45.]
...
wherever it is pasted. How an emoji is _set_ in print — a colour font, a
...
collapse, as for any #link("extra.md#three-universal-attributes")[zero-width node] —
...
#ts-callout(kind: "warning", title: [Icons do not reach the PDF])[
