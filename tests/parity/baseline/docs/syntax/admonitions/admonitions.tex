...
A callout with no \tscodeinline{title=} is titled after its kind, in the document's
\tscodeinline{language}: \tscodeinline{!!! tip} is \emph{Astuce} in a French document and \emph{Tipp} in a German
...
\tscodeinline{theme.language} accepts.

The \tscodeinline{name} of a kind you declare yourself is its title, in whatever language
...
\PY{+w}{  }\PY{n+nt}{declare}\PY{p}{:}
\PY{+w}{    }\PY{n+nt}{admonitions}\PY{p}{:}
\PY{+w}{      }\PY{n+nt}{note}\PY{p}{:}\PY{+w}{ }\PY{p+pIndicator}{\PYZob{}}\PY{n+nt}{name}\PY{p}{:}\PY{+w}{ }\PY{n+nv}{Remarque}\PY{p+pIndicator}{\PYZcb{}}
\PY{+w}{      }\PY{n+nt}{exercise}\PY{p}{:}\PY{+w}{ }\PY{p+pIndicator}{\PYZob{}}\PY{n+nt}{name}\PY{p}{:}\PY{+w}{ }\PY{n+nv}{Exercice}\PY{p+pIndicator}{\PYZcb{}}
\end{Verbatim}
\end{tscode}
