...
\end{Verbatim}
\end{code}
\section{Build the documentation locally}\label{build-the-documentation-locally}
...
\end{Verbatim}
\end{code}
\section{Test CI}\label{test-ci}

To test the Continuous Integration (CI) using GitHub Actions, we need \texttt{act} installed on your local machine:
