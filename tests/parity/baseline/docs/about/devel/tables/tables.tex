...
The \tscodeinline{texsmith.spantable} extension lets us span cells in standard Markdown tables.

The \tscodeinline{>>>} syntax will span cells horizontally, the \tscodeinline{vvv} syntax will span cells vertically.
