...
\thispagestyle{plain}
We want TeXSmith to support a global user configuration file located at \texttt{.texsmith/config.yml}. This file allows users to set their preferred defaults for templates, Mermaid styles, compilation options, and paper formats. The configuration file is optional and can be placed in the current working directory or any parent directory.
