...
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Return elastic modulus as a function of temperature and strain rate.\PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{k}{return} \PY{n}{E0} \PY{o}{*} \PY{p}{(}\PY{l+m+mi}{1} \PY{o}{\PYZhy{}} \PY{n}{alpha} \PY{o}{*} \PY{p}{(}\PY{n}{temperature} \PY{o}{\PYZhy{}} \PY{n}{T0}\PY{p}{)}\PY{p}{)} \PY{o}{*} \PY{p}{(}\PY{l+m+mi}{1} \PY{o}{+} \PY{n}{beta} \PY{o}{*} \PY{n}{np}\PY{o}{.}\PY{n}{log}\PY{p}{(}\PY{n}{strain\PYZus{}rate} \PY{o}{/} \PY{n}{eps\PYZus{}dot0}\PY{p}{)}\PY{p}{)}
