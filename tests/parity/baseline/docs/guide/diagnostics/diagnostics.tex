...
(\tscodeinline{report.md: warning crossref-\allowbreak{}inventory-\allowbreak{}missing: …}), and one that belongs to
no file at all --- an engine, a network or a template failure --- prints its code
and message alone (\tscodeinline{warning transformer-\allowbreak{}dependency-\allowbreak{}missing: …}).
...
\tscodeinline{-\allowbreak{}-\allowbreak{}diagnostics-\allowbreak{}json} and a CI filter can tell one from another.
\end{document}
