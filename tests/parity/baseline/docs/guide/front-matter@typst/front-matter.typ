...
Each template exposes its own set of attributes (cover styles, sidebar toggles, custom slots, …). Head over to the #link("templates/index.md")[Template Guide] for the full menu.
...
The full syntax, supported entry types, and resolution rules are documented in the #link("features/bibliography.md")[Bibliography Guide].
...
See the #link("fragments/glossary.md")[Glossary Guide] for sorting behavior, cross-references, and styling options.
...
See #link("../syntax/counters.md")[Custom counters] for the marker syntax, the
...
`RHE-423-FW-10 p. 14`. See #link("../syntax/crossrefs.md")[Cross-document references].
