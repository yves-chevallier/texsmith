...
\section{Inspect detected fallback fonts}\label{inspect-detected-fallback-fonts}

Use the render command with \texttt{-\allowbreak{}-\allowbreak{}fonts-\allowbreak{}info} to display the scripts and fonts that were detected during a build. The flag works for both direct \LaTeX{} output and full template renders:
...
\begin{itemize}
\item{} the script name and the generated LaTeX commands (\texttt{\textbackslash{}text<slug>} / \texttt{\textbackslash{}<slug>font});
