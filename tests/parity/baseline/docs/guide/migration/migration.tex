...
\midrule
\tscodeinline{[\^{}key]} citation & \tscodeinline{@key} & fmt; \tscodeinline{[\^{}1]} stays a \emph{footnote} \\
\tscodeinline{\^{}[k1,k2]} citation & \tscodeinline{@[k1; k2]} & fmt; \tscodeinline{\^{}[…]} then becomes an inline footnote \\
