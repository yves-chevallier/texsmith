...
\tscodeinline{latex.template.override}, fragment \tscodeinline{partials} and \tscodeinline{required\_partials} are
deprecated in 0.7.0 --- they warn and are ignored --- and removed in 0.8.0.
\href{partials.md\#former-partials}{Contract macros} maps every former partial to
