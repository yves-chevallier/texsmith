...
TeXSmith adds support for glossaries through the \tscodeinline{glossary} extension, which
...
\item If you define glossary entries using the \tscodeinline{glossary} directive.
\end{itemize}
\end{document}
