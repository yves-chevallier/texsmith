...
\begin{itemize}
\item \tscodeinline{fragment.toml} with \tscodeinline{name}, \tscodeinline{description}, and either an \tscodeinline{entrypoint} or a \tscodeinline{files} list.
...
A fragment's \tscodeinline{partials} and \tscodeinline{required\_partials} keys are deprecated in
