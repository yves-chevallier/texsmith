...
#align(center)[
  #text(size: 1.8em, weight: "bold")[TeXSmith Extensions]
]
#v(1.5em)
...
- Optional reader lowerings (`@reads`) and writer emitters (`@writes`) that
    ...
    Markdown layer (see #link("../api/handlers.md")[Readers & Writers]).
...
#link("../api/handlers.md")[Readers & Writers] for the decorators and a complete,
