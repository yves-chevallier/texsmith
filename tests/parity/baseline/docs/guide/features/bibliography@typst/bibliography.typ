...
BibTeX is an old, loosely specified format with many dialects (`bibtex`, `bibtex8`, `pbibtex`, and more). The most complete parser is #link("https://en.wikipedia.org/wiki/Biber_(LaTeX)")[biber], but it is Perl-based and not embeddable. TeXSmith relies on #link("https://pybtex.org/")[pybtex], which covers the common cases.
