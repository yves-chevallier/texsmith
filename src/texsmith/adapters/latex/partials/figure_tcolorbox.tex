...
\BLOCK{endif}
\BLOCK{-if caption}
%% The label must come after the caption so it captures the figure number
%% rather than the number of the enclosing section.
\captionof{figure}\BLOCK{if shortcaption}[\VAR{shortcaption}]\BLOCK{endif}{\VAR{caption}}\BLOCK{if label}\label{\VAR{label}}\BLOCK{endif}
\BLOCK{-elif label}
\label{\VAR{label}}
\BLOCK{-endif}
\end{center}
