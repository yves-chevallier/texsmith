...
% In twocolumn mode the article class degrades abstract to \section* — restore
% the standard single-column rendering (small font, quoted indentation).
...
\BLOCK{ if column_count > 1 and has_title_metadata }
\twocolumn[{%
\maketitle
\BLOCK{ if abstract }
\begin{abstract}
