...
% without break opportunities. This redefinition replaces the deprecated
% ``override`` partials of the manifest (codeblock.tex, codeinline.tex),
% which the legacy path still honours until 0.8.0. Guarded: ts-code is only
