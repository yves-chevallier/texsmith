...
\usepackage{amsmath} % Support align, and text in math mode
...
\BLOCK{ if resolved_index_engine == "texindy" }
...
\BLOCK{ if acronyms }\printglossary[type=\acronymtype]\BLOCK{ endif }
\BLOCK{ if glossary }\printglossary\BLOCK{ endif }
