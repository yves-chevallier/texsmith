"""The legacy :class:`HtmlReader` — lower a BeautifulSoup tree into :mod:`texsmith.ir.nodes`.

The twin of :mod:`texsmith.readers.html` for the legacy Python writers; deleted
with them in phase 5 of the TMark migration (``specs/tmark-migration.md``).
...
from texsmith.readers.html.registry import NotHandled, ReaderRegistry, ReadLevel
