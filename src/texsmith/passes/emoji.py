"""The ``emoji`` pass — registered no-op, not implemented in this wave.

TODO(migration 3.3): emoji clusters → Span{emoji=…} or twemoji Image.
...
@spec("emoji", stage="pre", needs_io=True)
