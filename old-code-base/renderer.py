...
class LaTeXRenderer:
    ...
    def __init__(
        ...
        self._context = RenderingContext(
            config=self.config,
        ...
        self._pipeline.collect_from(self)

        pre_stage_runner = self._make_pipeline_runner(RenderPhase.PRE)
        block_stage_runner = self._make_pipeline_runner(RenderPhase.BLOCK)
        post_stage_runner = self._make_pipeline_runner(RenderPhase.POST)
    ...
    @render_stage(phase=RenderPhase.PRE, priority=90)
    def render_navigable_string(
    ...
    @render_stage(phase=RenderPhase.PRE, priority=80)
    def render_unicode(
        self, soup: Tag, context: RenderingContext | None = None, **_: Any
    ):
    ...
    @render_stage(phase=RenderPhase.PRE, priority=30)
    def render_regex(
        self, soup: Tag, context: RenderingContext | None = None, **_: Any
    ):
    ...
    @render_stage(phase=RenderPhase.PRE, priority=50)
    def render_codeinline(
        self, soup: Tag, context: RenderingContext | None = None, **_: Any
    ):
    ...
    @render_stage(phase=RenderPhase.POST, priority=30)
    def render_mermaid(
        self, soup: Tag, context: RenderingContext | None = None, **kwargs
    ):
    ...
    @render_stage(phase=RenderPhase.BLOCK, priority=20)
    def render_epigraph(
        self, soup: Tag, context: RenderingContext | None = None, **_: Any
    ) -> Tag:
    ...
    @render_stage(phase=RenderPhase.PRE, priority=40)
    ...
    @render_stage(phase=RenderPhase.BLOCK, priority=70)
    def render_quote(
        self, soup: Tag, context: RenderingContext | None = None, **_: Any
    ):
        """Render blockquotes."""
    ...
    @render_stage(phase=RenderPhase.BLOCK, priority=10)
    def render_heading(
        self, soup: Tag, context: RenderingContext | None = None, **kwargs
    ):
    ...
    @render_stage(phase=RenderPhase.BLOCK, priority=30)
    def render_autoref(
        self, soup: Tag, context: RenderingContext | None = None, **_: Any
    ):
    ...
    @render_stage(phase=RenderPhase.PRE, priority=70)
    ...
    @render_stage(phase=RenderPhase.BLOCK, priority=60)
    def render_abbreviation(
        self, soup: Tag, context: RenderingContext | None = None, **_: Any
    ):
    ...
    @render_stage(phase=RenderPhase.PRE, priority=100)
    def render_emoji(
        self, soup: Tag, context: RenderingContext | None = None, **_: Any
    ):
    ...
    @render_stage(phase=RenderPhase.PRE, priority=110)
    def render_keystrokes(
        self, soup: Tag, context: RenderingContext | None = None, **_: Any
    ):
    ...
    @render_stage(phase=RenderPhase.BLOCK, priority=40)
    ...
    @render_stage(phase=RenderPhase.POST, priority=20)
    ...
    @render_stage(phase=RenderPhase.PRE, priority=120)
    def render_tabbed(
        self, soup: Tag, context: RenderingContext | None = None, **_: Any
    ):
    ...
    @render_stage(phase=RenderPhase.POST, priority=40)
    def render_figure(
        self, soup: Tag, context: RenderingContext | None = None, **kwargs
    ):
    ...
    @render_stage(phase=RenderPhase.POST, priority=50)
    def render_table(
        self, soup: Tag, context: RenderingContext | None = None, **kwargs
    ):
    ...
    @render_stage(phase=RenderPhase.BLOCK, priority=50)
    def render_links(
        self, soup: Tag, context: RenderingContext | None = None, **kwargs
    ):
    ...
    def render_elements(self, soup: Tag, **kwargs):
        ...
        self._context.update_runtime(**kwargs)
        try:
            for render in self.renderering_order[start:]:
                render(soup, **kwargs)
        finally:
            self._context.clear_runtime()
        return soup

    def _make_pipeline_runner(self, phase: RenderPhase):
        def runner(soup: Tag, **_: Any):
            self._pipeline.run_phase(phase, soup, self._context)
            return soup
