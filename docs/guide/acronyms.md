...
Following the proposition in MkDocs and `abbr` extension, TeXSmith supports defining acronyms using the footnote syntax.
...
*[NASA]:
    National Aeronautics and Space Administration is responsible for the
    civilian space program. APOLLO 11 was one of its most famous missions in which
...
Acronym definition share syntax with footnotes.
