...
- Fragments: `core.fragments` orchestrates fragment metadata/injection; builtin fragments under `builtin_fragments/ts_*` (callouts, code, glossary, bibliography, index, fonts, geometry, typesetting, extra, keystrokes, todolist) populate template slots.
