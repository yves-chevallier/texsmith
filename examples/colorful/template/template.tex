...
\BLOCK{ set squares = [
  {"slot": "nw", "origin": "0,0", "center": "5,5", "label": "NW", "content": nw, "color": colors.nw},
  {"slot": "ne", "origin": "10,0", "center": "15,5", "label": "NE", "content": ne, "color": colors.ne},
  {"slot": "sw", "origin": "0,10", "center": "5,15", "label": "SW", "content": sw, "color": colors.sw},
  {"slot": "se", "origin": "10,10", "center": "15,15", "label": "SE", "content": se, "color": colors.se},
] }
...
\begin{tikzpicture}[remember picture,overlay,x=1cm,y=1cm]
  ...
  {\parbox{\boxwidth}{\VAR{square.content|default('Slot ' ~ square.label, true)|trim}}};
  \BLOCK{ endfor }
\end{tikzpicture}
\end{document}
