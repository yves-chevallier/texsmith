...
This example demonstrates the `press.declare.counters` front-matter section
in TeXSmith.
...
items with `{counter}(prefix:key)` in table cells and in running prose, attaches one
