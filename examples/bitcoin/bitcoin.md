...
would include redoing all the blocks afte

![](4-proof-of-work.tikz)
...
The interior hashes do not need to be st

![Reclaiming-disk-space](7-reclaiming-disk-space.tikz)
...
![Simplified-payment-verification](8-simplified-payment-verification.tikz)

As such, the verification is reliable as long as honest nodes trol the network,
...
![Splitting value](9-combining-and-splitting-value.tikz)
...
![Privacy through anonymous keys](10-privacy.tikz)
