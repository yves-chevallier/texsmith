...
\BLOCK{ if bibliography_resource }\addbibresource{\VAR{bibliography_resource}}\BLOCK{ else }\addbibresource{mitthesis-sample.bib}\BLOCK{ endif }%% <== change to YOUR bib file <= CHANGE
