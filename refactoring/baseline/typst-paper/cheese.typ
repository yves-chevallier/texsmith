...
The figure #link("#melting-behavior") illustrates the melting behavior of Mozzarella
...
table #link("#mechanical-results") summarizes the measured moduli.
...
#bibliography("cheese-refs.bib", style: "ieee")
