...
CLI_CASES: tuple[Case, ...] = (
    ...
    Case(
        ...
        note="drawio/mermaid rendered via the default playwright backend (no Docker required).",
    ),
    ...
    Case(
        ...
        "mermaid",
        ("mermaid.md", "-tarticle"),
        note="mermaid rendered via the default playwright backend (no Docker required).",
    ),
